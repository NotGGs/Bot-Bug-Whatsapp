...
//—————「 Set Nama Bot & Own 」—————//
global.namabot = 'Reelly Bot'
global.namaowner = 'Reelly XD'

//—————「 Setting Owner 」—————//
global.owner = ['6281215502214']
global.ownernomer = "6281215502214"
global.premium = ['62895388290404,6287836742857']
global.ultah = 'September 4, 2024'

//—————「 Setting Donasi 」—————//
global.dana = ''

//—————「 Set Kebutuhan Button 」—————//
global.email = 'gregcyber@gmail.com'
global.namaweb = 'Youtube'
global.myweb = 'https://youtube.com/@GREGOR1US'
global.region = 'Indonesia'
global.github = 'https://github.com/NotGGs/AOXdeface'
global.mygc = 'https://chat.whatsapp.com/Lfg4UKGryV6IDBrEKaZlQg'
global.myig = 'https://instagram.com/gregorius_bro_01'

//—————「 Set Wm 」—————//
global.packname = 'Sticker By\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n'
global.author = 'Reelly Bot\nMade By Reelly XD'
...
global.botname = 'Reelly Bot'
global.akulaku = 'Bot By Reelly XD'
global.ttname = 'YouTube Reelly XD'
